            ...
            <tbody class="divide-y divide-neutral-300 dark:divide-neutral-700">
                <?php foreach ($flight_schedules as $schedule) : ?>
                    <tr class="even:bg-black/5 dark:even:bg-white/10">
                        ...
                        <td class="p-4" data-field="airline_user_name"><?= $schedule['airline_user_name'] ?? 'N/A' ?></td>
                        ...
                        <td class="p-4" data-field="departure"><?= ($schedule['date_departure'] ?? 'N/A') . ' ' . ($schedule['time_departure'] ?? '') ?></td>
                        <td class="p-4" data-field="arrival"><?= ($schedule['date_arrival'] ?? 'N/A') . ' ' . ($schedule['time_arrival'] ?? '') ?></td>

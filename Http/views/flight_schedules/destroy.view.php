<div x-cloak x-show="showDeleteModal" x-transition.opacity.duration.200ms
    x-on:keydown.esc.window="showDeleteModal = false" x-on:click.self="showDeleteModal = false"
    ...
    <div x-show="showDeleteModal"
        ...
        <div class="flex items-center justify-between border-b border-neutral-300 bg-neutral-50/60 p-4 dark:border-neutral-700 dark:bg-neutral-950/20">
            <h3 id="defaultModalTitle" class="font-semibold tracking-wide text-neutral-900 dark:text-white">Delete Flight Schedule?</h3>
            <button x-on:click="showDeleteModal = false" aria-label="close modal">
        ...
        <!-- Dialog Body -->
        <div class="px-4 py-8">
            <p>Are you sure you want to delete this flight schedule? This action is irreversible.</p>
        </div>
        <!-- Dialog Footer -->
        <form action="/flight-schedules" method="POST" class="flex flex-col-reverse justify-between gap-2 border-t border-neutral-300 bg-neutral-50/60 p-4 dark:border-neutral-700 dark:bg-neutral-950/20 sm:flex-row sm:items-center md:justify-end">
            ...
            <button x-on:click="showDeleteModal = false" type="submit"

<div x-cloak x-show="showSeatsModal" x-transition.opacity.duration.200ms
    ...
    <div x-show="showSeatsModal"
        ...
        class="flex max-h-[80svh] overflow-y-auto max-w-lg flex-col gap-4 overflow-hidden rounded-sm border border-neutral-300 bg-white text-neutral-600 dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-300">
        <!-- Dialog Header -->

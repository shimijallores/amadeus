            ...
            <tbody class="divide-y divide-neutral-300 dark:divide-neutral-700">
                <?php foreach ($flight_routes as $route) : ?>
                    <tr class="even:bg-black/5 dark:even:bg-white/10">
                        ...
                        <td class="p-4" data-field="origin_airport_name"><?= $route['origin_airport_name'] ?? 'N/A' ?></td>
                        <td class="p-4" data-field="destination_airport_name"><?= $route['destination_airport_name'] ?? 'N/A' ?></td>

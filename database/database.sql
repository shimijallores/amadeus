...
-- Dumping structure for table global_distribution_system.aircraft
...
-- Dumping data for table global_distribution_system.aircraft: ~10 rows (approximately)
...
-- Dumping structure for table global_distribution_system.airlines
...
-- Dumping data for table global_distribution_system.airlines: ~10 rows (approximately)
INSERT INTO `airlines` (`id`, `iata`, `icao`, `airline`, `callsign`, `country`, `comments`) VALUES
	...
	(3, 'AL3', 'ICL3', 'Airline Three', 'THREEAIR', 'Canada', ''),
...
-- Dumping structure for table global_distribution_system.airline_users
...
-- Dumping structure for table global_distribution_system.airports
...
-- Dumping data for table global_distribution_system.airports: ~10 rows (approximately)
...
-- Dumping structure for table global_distribution_system.flight_routes
...
-- Dumping data for table global_distribution_system.flight_routes: ~0 rows (approximately)
...
-- Dumping structure for table global_distribution_system.flight_schedules
...
-- Dumping data for table global_distribution_system.flight_schedules: ~30 rows (approximately)
INSERT INTO `flight_schedules` (`id`, `airline_user_id`, `flight_route_id`, `date_departure`, `time_departure`, `date_arrival`, `time_arrival`, `status`) VALUES
	...
	(51, 7, 7, '2025-09-03', '08:00', '2025-09-03', '10:00', 'Scheduled'),
	(52, 8, 8, '2025-09-03', '09:00', '2025-09-03', '11:00', 'Scheduled'),
	(53, 9, 9, '2025-09-03', '10:00', '2025-09-03', '12:00', 'Scheduled'),
	...
	(66, 7, 7, '2025-09-03', '08:00', '2025-09-03', '10:00', 'Scheduled'),
	(67, 8, 8, '2025-09-03', '09:00', '2025-09-03', '11:00', 'Scheduled'),
	(68, 9, 9, '2025-09-03', '10:00', '2025-09-03', '12:00', 'Scheduled'),
